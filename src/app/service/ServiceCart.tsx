...
export default function ServiceCart() {
  const { updateQuantity, cart, serviceDate: serviceDateStr } = useCartStore();
  ...
  return (
    <>
      ...
      <aside className="hidden xl:flex flex-col w-96 h-full pt-10 pl-8 border-l border-gray-200 sticky top-0">
        <div className="flex flex-col h-[calc(100vh-120px)] bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/50 transition-all hover:shadow-2xl hover:shadow-gray-300/30 overflow-hidden">
          <div className="p-8 flex flex-col h-full">
            ...
            {cart.products.length > 0 && (
              <div className="shrink-0">
                <ServiceDatePicker className="mt-2 mb-4" />

                {/* Address Selection */}
                <div className="mb-8 p-6 bg-gray-50/50 rounded-[2rem] border border-gray-100 group transition-all hover:bg-white hover:shadow-xl hover:shadow-gray-200/40">
