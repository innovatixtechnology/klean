    ...
    <footer className="bg-[#EEF4FB] mt-20 pb-10">
      <div className="w-[90%] mx-auto ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 mt-12 gap-10 md:gap-8 border-b border-[#C6C6C6] pb-12">
          ...
          <div className="mt-4">
            <a href={siteConfig.contact.whatsappHref} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full font-bold shadow-lg shadow-[#25D366]/30 hover:bg-[#20bd5a] transition-all hover:-translate-y-1 active:translate-y-0 relative overflow-hidden group">
              <Image src="/images/whatsapp.svg" alt="whatsapp" width={20} height={20} />
